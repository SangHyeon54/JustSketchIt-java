...
public class JSIEventListener implements MouseListener, MouseMotionListener, 
    KeyListener{
    //fields
    ...
    public void mousePressed(MouseEvent e) {
        if (this.mApp.getPenMarkMgr().mousePressed(e)) {       
            JSIScene curScene = (JSIScene) this.mApp.getScenarioMgr().
                getCurScene();
    ...
    public void mouseDragged(MouseEvent e) {
        if (this.mApp.getPenMarkMgr().mouseDragged(e)) {
            JSIScene curScene = (JSIScene) this.mApp.
